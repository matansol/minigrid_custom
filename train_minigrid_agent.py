...
def main(**kwargs):
    ...
    colors_options = [
        # AllColors LL  - 0
        {'balls': {'red': 4, 'green': 4, 'blue': 4}, 'lava': 0, 'step': 0.1},
        # AllColors LH  - 1
        {'balls': {'red': 4, 'green': 4, 'blue': 4}, 'lava': -3, 'step': 0.1},
        # OnlyBlue LH  - 2
        {'balls': {'red': -2, 'green': -2, 'blue': 4}, 'lava': -3, 'step': 0.1},
        # OnlyBlue LL  - 3
        {'balls': {'red': -2, 'green': -2, 'blue': 4}, 'lava': 0, 'step': 0.1},
        # NoRed LL  - 4
        {'balls': {'red': -1, 'green': 3, 'blue': 4}, 'lava': 0, 'step': 0.2},
        # NoRed LH  - 5
        {'balls': {'red': -1, 'green': 2, 'blue': 4}, 'lava': -3, 'step': 0.1},
        # NoGreen LL  - 6   
        {'balls': {'red': 2, 'green': -1, 'blue': 4}, 'lava': 0, 'step': 0.2},
        # NoGreen LH - 7
        {'balls': {'red': 3, 'green': -1, 'blue': 4}, 'lava': -3, 'step': 0.1},
        # OnlyGreen LH - 8
        {'balls': {'red': -2, 'green': 4, 'blue': -2}, 'lava': -3, 'step': 0.1},
        # OnlyGreen LL - 9
        {'balls': {'red': -1, 'green': 4, 'blue': -1}, 'lava': 0, 'step': 0.1},
    ]  # size = 10
    ...
    max_steps = 70  # Reduced from 50 for faster learning
